...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PsychStormEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PsychStormEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "221";
		app.meta["company"] = "com.JPE.PsychStormEngine";
		app.meta["file"] = "PsychStormEngine";
		app.meta["name"] = "FNF': Psych Storm Engine";
		app.meta["packageName"] = "com.JPE.PsychStormEngine";
		...
		#elseif air
		app.window.title = "FNF': Psych Storm Engine";
		#else
		app.window.context.attributes.background = 5592405;
