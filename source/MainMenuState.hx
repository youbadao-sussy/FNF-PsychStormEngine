...
class MainMenuState extends MusicBeatState
{
	...
	var debugKeysmode:Array<FlxKey>;//追加
	...
	override function create()
	{
		...
		//追加
		debugKeysmode = ClientPrefs.copyKey(ClientPrefs.keyBinds.get('debug_3'));
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					CoolUtil.browserLoad('https://fnf-jpsych-engine.jimdofree.com/');
				}
				else
				{
					selectedSomethin = true;
			...
			else if (FlxG.keys.anyJustPressed(debugKeysmode))
			{
				selectedSomethin = true;
				MusicBeatState.switchState(new ModsMenuState());
			}
