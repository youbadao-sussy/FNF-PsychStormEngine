...
class TypedAlphabet extends Alphabet
{
	...
	public function new(x:Float, y:Float, text:String = "", ?font = '', ?delay:Float = 0.05, ?bold:Bool = false, ?size = 24)
	{
		super(x, y, text, bold, size, font);
	...
	override private function set_font(newFont:String)
	{
		super.set_font(newFont);
