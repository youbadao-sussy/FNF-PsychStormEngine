...
class ClientPrefs {
	...
	public static function saveSettings() {
		...
		FlxG.save.data.dialoguelanguage = dialoguelanguage;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.dialoguelanguage != null) {
			dialoguelanguage = FlxG.save.data.dialoguelanguage;
		}
...
class ClientPrefs {
	...
	inline public static function getGameplaySetting(name:String, defaultValue:Dynamic):Dynamic {
		return //PlayState.isStoryMode ? defaultValue : 
		 (gameplaySettings.exists(name) ? gameplaySettings.get(name) : defaultValue);
	}
	public static function reloadControls() {
		PlayerSettings.player1.controls.setKeyboardScheme(KeyboardScheme.Solo);
